...
项目中的服务使用 .Net Core 6.0 新增的 Minimal API 方式代替原有的 Web API 实现
...
await _daprClient.PublishEventAsync("pubsub",nameof(OrderStatusChangedToValidatedIntegrationEvent), @event);
```
